...
#Octobre 2019    
    ...
    library(ggthemes)
    library(optparse)
    #EXEMPLE Rscript 02_Analyse_sets.r -i /home/guest/Desktop/Cheryn_ALI_Projet_IDH/Premiere_partie/DATA/ -o /home/guest/Desktop/Cheryn_ALI_Projet_IDH/Premiere_partie/RESULTATS/
#Param
    option_list = list(
        make_option(c("-i", "--input_path"), type="character", default="/home/guest/Desktop/Cheryn_ALI_Projet_IHD/Premiere_partie/DATA/", 
...
#Functions
    ggboxplot_simple= function(vector, vector_name="", notch=TRUE,title="", sub="",ylab="",ylim=NULL, legend = TRUE, tick_angle=0, x_abline=NULL ){
...
#nbr of goterms per proteines
    ...
    nbgoterm_per_prot_dir_boxplot = ggboxplot_simple(as.vector(nbgoterm_per_prot_dir_filt_dataFrame[,2]), "nbGo_per_prot", notch=FALSE,
        title="Nbr of direct annotations per protein", 
    ...
    nbprot_per_goterm_dir_density = ggdensity(nbgoterm_per_prot_dir_filt_dataFrame, x = "nbGO",
        add = "mean", rug = TRUE,
        title = "Density Nbr of direct annotations per protein")
    ...
    nbgoterm_per_prot_dir_imp_boxplot = ggboxplot_simple(as.vector(nbgoterm_per_prot_dir_imp_filt_dataFrame[,2]), "nbGo_per_prot", notch=FALSE,
        title="Nbr of direct and implicit annotations per protein", 
    ...
    nbprot_per_goterm_dir_imp_density = ggdensity(nbgoterm_per_prot_dir_imp_filt_dataFrame, x = "nbGO",
        add = "mean", rug = TRUE,
        title = "Density Nbr of direct and implicit annotations per protein")
...
#nbr of per proteines per goterms
    ...
    nbprot_per_goterm_dir_boxplot = ggboxplot_simple(as.vector(nbprot_per_goterm_dir_filt_dataFrame[,3]), "nbProt_per_GOterm", notch=FALSE,
        title="Nbr of proteins directly annotated per term", 
    ...
    nbprot_per_goterm_dir_density = ggdensity(nbprot_per_goterm_dir_filt_dataFrame, x = "prot",
        add = "mean", rug = TRUE,
        title = "Density Nbr of proteins directly annotated per term",
        color = "go_type", 
    ...
    nbprot_per_goterm_dir_imp_boxplot = ggboxplot_simple(as.vector(nbprot_per_goterm_dir_imp_filt_dataFrame[,3]), "nbGo_per_prot", notch=FALSE,
        title="Nbr of proteins directly and implicitly annotated per term", 
        sub=paste0("Nbr of proteins = ", nrow(nbprot_per_goterm_dir_imp_filt_dataFrame), " (",nbrGO_whitout_data_dir_imp," obselete term) Mean = ", mean(nbprot_per_goterm_dir_imp_filt_dataFrame[,3])),
        ylim=c(0,25), legend = FALSE, tick_angle=0 )
    
    nbprot_per_goterm_dir_imp_density = ggdensity(nbprot_per_goterm_dir_imp_filt_dataFrame, x = "prot",
        add = "mean", rug = TRUE,
        title = "Density Nbr of proteins directly and implicitly annotated per term",
        color = "go_type", 
        palette = c("#00AFBB", "#E7B800","#F6A3A3"))
